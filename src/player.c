...
void setPlayerHp_sub_1367230(float target_health)
{
  ...
  {
    player_hp = (float)_gameFWorkChk_sub_135e388(0xb);
  }
  else
  {
    player_hp = 0.0;
...

{
  ...
  if (hp_to_add < 0.0)
  {
    player_max_hp = (float)gStatGetPlayerAccessoriesDamgeRaitoToPlayer_sub_1362938();
    hp_to_add = hp_to_add * player_max_hp;
  }
  hp_to_add = player_hp + hp_to_add;
  player_max_hp = _gameFWorkChk_sub_135e388(0xb);
  if (player_max_hp < hp_to_add)
  {
    player_hp = _gameFWorkChk_sub_135e388(0xb);
  }
  else
  {
    player_hp = hp;
  ...
  hp = getPlayerHp_sub_1367220();
  player_max_hp = getPlayerMaxHp_sub_13673d0();
  playerlifebar_sethp_sub_1400088(hp / player_max_hp);
  return;
}
